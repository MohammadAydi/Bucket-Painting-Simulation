...
public class FluidManager : MonoBehaviour
{
    ...
    DensityRenderSystem _densityRenderSystem;
    bool _initialized;
    ...
    void InitializeSystems()
    {
        ...
        _spawnSystem = new SpawnSystem(settings);
        _physicsSystem = new PhysicsSystem(fluidComputeShader);
        ...
        _renderSystem = new RenderSystem(particleMaterial);
        _densityRenderSystem = new DensityRenderSystem(densityFieldMaterial);

        ParticleData[] particles = _spawnSystem.SpawnParticles(BoundsMin, BoundsMax);
