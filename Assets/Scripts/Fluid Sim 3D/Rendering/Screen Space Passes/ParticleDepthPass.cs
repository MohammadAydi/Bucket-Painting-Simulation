...
public class ParticleDepthPass : ScriptableRenderPass, System.IDisposable
{
    ...
    public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
    {
        ...
        // Both remaining mixing models (LinearRGB, Mixbox) store the pigment
        // buffer as already-displayable RGB, so the shader no longer needs
        // to know which mode is active (RYB — the one mode requiring a
        // shader-side decode — has been removed).
